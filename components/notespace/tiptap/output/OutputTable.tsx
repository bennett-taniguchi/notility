...
function NoteOptions({
  ...
  function OutputContentButtons({setEditorVisible,Router}) {
    ...
    return(
        ...
        <GuideDialog visible={guideDialogOpen} setVisible={setGuideDialogOpen} uri={slug} Router={Router}/>
        <Button variant={"outline"} className="ml-[2svw]"  onClick={()=>openSelectedDialog('Guide')}>
          Create new Guide
        </Button>

        <QuizDialog visible={quizDialogOpen} setVisible={setQuizDialogOpen} uri={slug} Router={Router}/>
        <Button variant={"outline"} className="ml-[2svw]" onClick={()=>openSelectedDialog('Quiz')}>
          Create new Quiz
        </Button>

        <TestDialog visible={testDialogOpen} setVisible={setTestDialogOpen} uri={slug} Router={Router}/>
        <Button variant={"outline"} className="ml-[2svw]"  onClick={()=>openSelectedDialog('Test')}>
          Create new Test
        </Button>
      </div>
    )
...
export default function OutputTable({
    ...
    return (
      <div>
       ...
       <OutputContentButtons setEditorVisible={setEditorVisible} Router={Router}/>
      </div>
    );
  }