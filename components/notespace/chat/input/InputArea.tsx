    ...
    <div>
      <form onSubmit={handleSubmit} className="flex justify-center ">
        <input
          ...
          maxLength={500}
          className={cn(
            "border-2 border-sky-400/50 h-[70px] align-top rounded-md focus:ring-[2px] focus:outline-none fixed bottom-4  mx-auto p-2 my-[1svh]  ml-[3svw]     shadow-md shadow-indigo-100 ",
            collapse == "output" ? "w-[90svw]" : "w-[45svw]"
          )}
          value={input}
          ...
          <TooltipProvider>
            <Tooltip delayDuration={0}>
              <TooltipTrigger asChild>
                <TrashIcon
                  className={cn(
                    " fixed  bottom-[5.5svh]  scale-150 hover:stroke-red-400   hover:stroke-[.7] rounded-full  ",
                    collapse == "output" ? "right-[7svw]" : "right-[54svw]"
                  )}
