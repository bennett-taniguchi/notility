...
export default function Notespace() {
  ...
  return (
    <div className="w-[100svw] h-[100svh] bg-cyan-500/60 grid grid-rows-1 gap-2">
        ...
        <div className="w-[100svw] h-[10svh]  drop-shadow-md border-b-slate-200 reverse-chat-background flex flex-row divide-x-2 ">
          <div
        ...
        <div className="w-[100svw] h-[90svh] chat-background">
